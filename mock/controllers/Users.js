...
module.exports.getUserByName = function getUserByName (req, res, next, userId) {
  Users.getUserByName(userId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getUsersByCompany = function getUsersByCompany (req, res, next) {
